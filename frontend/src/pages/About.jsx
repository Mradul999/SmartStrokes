        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 transform transition-all hover:shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
              ...
              <h3 className="text-lg font-semibold text-purple-800 mb-2">Personalized Practice</h3>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-6 border border-indigo-200">
              ...
              <h3 className="text-lg font-semibold text-indigo-800 mb-2">Performance Analytics</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
              ...
              <h3 className="text-lg font-semibold text-blue-800 mb-2">Interactive Interface</h3>
              <p className="text-gray-700">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 transform transition-all hover:shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {developers.map((dev, index) => (
              <div key={index} className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6 border border-purple-100 flex flex-col md:flex-row items-center gap-6 transition-all hover:shadow-md">
                ...
                <div>
                  ...
                  <a 
                    ...
                    className="inline-flex items-center px-3 py-1.5 bg-gray-800 text-white rounded-lg text-sm hover:bg-gray-700 transition-colors"
                  >
